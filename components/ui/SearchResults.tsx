          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {results.map((product) => (
              <div
                ...
                className="group bg-brand-dark-2 rounded-2xl border border-white/5 hover:border-brand-orange/30 overflow-hidden cursor-pointer transition-all hover:shadow-xl hover:shadow-brand-orange/5 flex flex-col"
              >
